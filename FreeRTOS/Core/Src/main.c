...
#if( defined(configUSE_SEGGER_SYSTEM_VIEWER_HOOKS) && (configUSE_SEGGER_SYSTEM_VIEWER_HOOKS != 0) )
...
extern UART_HandleTypeDef huart2; // Make sure UART2 is initialized in MX_USART2_UART_Init()
